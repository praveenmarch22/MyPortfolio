  ...
  const projects = [
    {
      ...
      links: {
        github: "https://github.com/praveenmarch22/DevTinder-web",
        live: "#"
      }
    },
    {
      ...
      links: {
        github: "https://github.com/praveenmarch22/FoodApp",
        live: "#"
      }
    },
    {
      ...
      links: {
        github: "https://github.com/praveenmarch22/WeTube",
        live: "#"
      }
    }
  ];
        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            ...
            >
              {/* Project Header */}
              <div 
                className={`p-8 text-white relative overflow-hidden bg-gradient-to-r ${project.gradient}`}
              >
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, idx) => (
                      <span
                        key={idx}
                        className={`px-4 py-2 rounded-xl text-sm font-medium text-white shadow-md bg-gradient-to-r ${project.gradient}`}
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    className={`flex-1 px-6 py-3 rounded-xl font-medium text-center transition-all duration-200 text-white shadow-lg flex items-center justify-center gap-2 bg-gradient-to-r ${project.gradient}`}
                  >
